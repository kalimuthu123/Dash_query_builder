...
- Parameterarray (boolean | number | string | dict | list; optional):
    The Parameterarray displayed in the input.

- columns (boolean | number | string | dict | list; optional):
    The columns displayed in the input.

- conditionArray (boolean | number | string | dict | list; optional):
...
- value (boolean | number | string | dict | list; optional):
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.UNDEFINED, value=Component.UNDEFINED, columns=Component.UNDEFINED, Parameterarray=Component.UNDEFINED, conditionArray=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'Parameterarray', 'columns', 'conditionArray', 'label', 'value']
        self._type = 'QueryBuilder'
        self._namespace = 'query_builder'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'Parameterarray', 'columns', 'conditionArray', 'label', 'value']
